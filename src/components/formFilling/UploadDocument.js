...
console.log("visaRequests", visaRequests.visaRequest);
  ...
  console.log("testing map", visaRequests.visaRequest.map((item) => item.request.visa.givenName));
                  ...
                  >
                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                      ...
                      <p className="mb-2 text-sm text-gray-500">
                        {uploadedFiles[label] ? uploadedFiles[label].name : 'Click to upload or drag and drop'}
                      </p>
                    </div>
                    <input
                      id={`file-${label}`}
